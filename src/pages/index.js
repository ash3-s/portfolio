...
const Index = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-black to-gray-700 ">
        ...
        <nav className="bg-black opacity-75">
          ...
          <div className={`${isOpen ? "block" : "hidden"} sm:hidden`}>
            <div className="px-2 pt-2 pb-3 space-y-1 transition duration-200 ease-out">
              <a
                href="#"
                className="block px-3 py-2 rounded-md text-base font-medium text-white focus:bg-gray-800 focus:outline-none focus:text-white"
              >
                About
              </a>
              <a
              ...
              <a
                href="#"
                className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-800 focus:outline-none focus:text-white focus:bg-gray-900"
              >
                Contact
              </a>
            </div>
      ...
      <h1 className="opacity-90 transition-opacity duration-1000 ease-in-out hover:from-violet-400 hover:to-sky-400 hover:drop-shadow-lg hover:opacity-100 py-72 font-Rampart text-transparent bg-clip-text text-center font-bold text-8xl bg-gradient-to-r from-sky-400 via-violet-400 to-purple-500 ">
